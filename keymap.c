...
[_BASE] = {
  ...
  {KC_LCTL, MO(_FUNC), LALT_T(KC_CAPS), KC_LGUI, MO(_NUMB), KC_SPC, KC_SPC, MO(_SYMB), KC_RGUI, KC_RALT, MO(_FUNC)  , KC_RCTL }
},
 ...
 */
[_NUMB] = {
  {_______, _______, _______      , DK_LABK   , DK_RABK  , _______, _______, KC_7   , KC_8   , KC_9   , DK_PLUS, _______},
 ...
 */
[_SYST] = {
  { MU_ON , _______, _______, _______, _______   , _______, _______, _______, _______, _______, _______, _______},
  { MU_OFF, _______, _______, _______, _______   , _______, _______, _______, _______, _______, _______, _______},
